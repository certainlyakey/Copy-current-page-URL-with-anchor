...
cm.Item({
	...
	context:  require("sdk/context-menu").SelectorContext("h1[id], h2[id], h3[id], h4[id], h5[id], h6[id], p[id], section[id], article[id], blockquote[id], a[id], img[id], ul[id], ol[id], li[id], aside[id], header[id], footer[id], figure[id], span[id], nav[id], input[id]"), 
